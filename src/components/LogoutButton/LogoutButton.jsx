...
const StyledWrapper = styled.div`
  ...
  .sign svg { width: 17px; }
  .sign svg path { fill: rgb(240, 20, 20); } /* Ícono rojo */
  .text {
  ...
  .Btn:hover {
    width: 155px; border-radius: 40px; transition-duration: .3s;
    background-color: rgb(240, 20, 20); /* Fondo rojo en hover */
  }
  .Btn:hover .sign {
    width: 30%; transition-duration: .3s; padding-left: 20px;
  }
  .Btn:hover .sign svg path { fill: white; }
  .Btn:hover .text {
